...
class MapChangeDispatcher {
  ...
  void onCameraIsChanging() {
    ...
    if (mapChangeHandler != null) {
      mapChangeHandler.onCameraIsChanging();
    }
  ...
  void onCameraDidChange(boolean animated) {
    ...
    if (mapChangeHandler != null) {
      mapChangeHandler.onCameraDidChange(animated);
    }
  ...
  void onDidFinishLoadingMap() {
    ...
    if (mapChangeHandler != null) {
      mapChangeHandler.onDidFinishLoadingMap();
    }
  ...
  void onDidFinishRenderingFrame(boolean partial) {
    ...
    if (mapChangeHandler != null) {
      mapChangeHandler.onDidFinishRenderingFrame(partial);
    }
  ...
  void onDidFinishLoadingStyle() {
    ...
    if (mapChangeHandler != null) {
      mapChangeHandler.onDidFinishLoadingStyle();
    }
  ...
  public void bind(MapChangeHandler mapChangeResultHandler) {
    this.mapChangeHandler = mapChangeResultHandler;
  }
}