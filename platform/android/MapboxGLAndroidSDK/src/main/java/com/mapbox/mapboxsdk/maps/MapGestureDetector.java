...
final class MapGestureDetector {
  ...
  private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
    ...
    private static final int ANIMATION_TIME_MULTIPLIER = 66;
    private static final double ZOOM_DISTANCE_DIVIDER = 2.75;
  ...
  private class RotateGestureListener extends RotateGestureDetector.SimpleOnRotateGestureListener {
    ...
    private static final float ROTATE_INVOKE_ANGLE = 15.5f;
    ...
    private Animator createAnimator(double currentRotation, double rotateAdditionDegrees) {
      ...
      animator.setDuration((long) Math.abs(rotateAdditionDegrees) * 3);
      animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
        @Override
        public void onAnimationUpdate(ValueAnimator animation) {
