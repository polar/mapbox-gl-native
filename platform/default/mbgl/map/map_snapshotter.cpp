...
public:
    ...
    void setStyle(std::unique_ptr<style::Style> style);
    std::unique_ptr<style::Style> getStyle() const;
...
void MapSnapshotter::Impl::setStyle(std::unique_ptr<style::Style> style) {
    map.setStyle(std::move(style));
}

std::unique_ptr<style::Style> MapSnapshotter::Impl::getStyle() const {
    return std::make_unique<style::Style>(map.getStyle());
}
...
void MapSnapshotter::setStyle(std::unique_ptr<style::Style> style) {
    impl->actor().invoke(&Impl::setStyle, std::move(style));
}

std::unique_ptr<style::Style> MapSnapshotter::getStyle() const {
    return impl->actor().ask(&Impl::getStyle).get();
}
