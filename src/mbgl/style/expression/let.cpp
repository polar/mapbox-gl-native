...
ParseResult Let::parse(const mbgl::style::conversion::Value& value, ParsingContext ctx) {
...
ParseResult Var::parse(const mbgl::style::conversion::Value& value_, ParsingContext ctx) {
    using namespace mbgl::style::conversion;
